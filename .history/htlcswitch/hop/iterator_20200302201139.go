...
const (
	...
	// ActiniumHop denotes that an HTLC is to be forwarded along the
	// Actinium link with the specified short channel ID.
	ActiniumHop
)
...
>>>>>>> 1467cd4dd382f9de7dc7ee89d779324ee9d2b4da:htlcswitch/hop/iterator.go
