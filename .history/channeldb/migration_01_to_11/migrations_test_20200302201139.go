...
<<<<<<< HEAD:channeldb/migrations_test.go
	"github.com/Actinium-project/lnd/lnwire"
=======
	"github.com/lightningnetwork/lnd/lntypes"
	"github.com/lightningnetwork/lnd/lnwire"
>>>>>>> 1467cd4dd382f9de7dc7ee89d779324ee9d2b4da:channeldb/migration_01_to_11/migrations_test.go
)
	...
	testCases := []struct {
	...
	}{
		{
			...
			closeSummary: &ChannelCloseSummary{
				...
				SettledBalance: acmutil.Amount(50000),
