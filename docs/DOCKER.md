...
```
$ docker create --name=lnd Actinium-project/lnd [command-line options]
```
...
```
$ docker create --name=lnd -v /media/lnd-docker/:/root/.lnd Actinium-project/lnd [command-line options]
```
...
```
$ docker create --name lnd-testnet Actinium-project/lnd --bitcoin.active --bitcoin.testnet --bitcoin.node=neutrino --neutrino.connect=faucet.lightning.community
```
