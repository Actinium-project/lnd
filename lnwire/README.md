...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/Actinium-project/lnd/lnwire)
...
```bash
$ go get -u github.com/Actinium-project/lnd/lnwire
```
