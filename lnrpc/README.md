...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/Actinium-project/lnd/lnrpc)
...
description):
  ...
  * WalletBalance
     * Returns the wallet's current confirmed balance in LTC.
  * ChannelBalance
     * Returns the daemons' available aggregate channel balance in LTC.
  * GetTransactions
...
5. Run [`gen_protos.sh`](https://github.com/Actinium-project/lnd/blob/master/lnrpc/gen_protos.sh) to generate new protobuf definitions.
