...
type AgentConstraints interface {
	...
	ChannelBudget(chans []Channel, balance acmutil.Amount) (
		acmutil.Amount, uint32)
...
func NewConstraints(minChanSize, maxChanSize acmutil.Amount, chanLimit,
...
func (h *agentConstraints) ChannelBudget(channels []Channel,
	funds acmutil.Amount) (acmutil.Amount, uint32) {
	...
	var totalChanAllocation acmutil.Amount
	...
	targetAllocation := acmutil.Amount(float64(totalFunds) * h.allocation)
...
//
// Note: part of the AgentConstraints interface.
func (h *agentConstraints) MinChanSize() acmutil.Amount {
...
//
// Note: part of the AgentConstraints interface.
func (h *agentConstraints) MaxChanSize() acmutil.Amount {
